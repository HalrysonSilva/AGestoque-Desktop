...
type
  ...
  Tformcontaestoque = class(TForm)
    ...
    btnapagahistorico: TBitBtn;
    btnRetomarProgresso: TBitBtn;
    btnconsultprevenda: TBitBtn;
...
var
  formcontaestoque: Tformcontaestoque;
...
function Tformcontaestoque.VerificarConferenciaCompleta: Boolean;
var
  BM: TBookmark;
  CodInterno: string;
begin
...
procedure Tformcontaestoque.btnlimpalistaClick(Sender: TObject);
begin
...
procedure Tformcontaestoque.btnmovimentoClick(Sender: TObject);
begin
  ...
  formmov.CarregaMovProdutosContados;


end;

procedure Tformcontaestoque.btnprodconfClick(Sender: TObject);
var
  NovoIndice: Integer;
begin
...
procedure Tformcontaestoque.btnprodvendClick(Sender: TObject);
var
  NovoIndice: Integer;
begin
  // 1. Verifica se o PageControl existe
...
procedure Tformcontaestoque.btnapagahistoricoClick(Sender: TObject);
var
...
procedure Tformcontaestoque.btnapagarClick(Sender: TObject);
begin
...
procedure Tformcontaestoque.btnatualizaestoqueClick(Sender: TObject);
begin
AjustarEstoqueEAtualizarMovimento(Sender);
end;

procedure Tformcontaestoque.btnatualizahistClick(Sender: TObject);
var
  Msg: String;
...
procedure Tformcontaestoque.btnconfirmarClick(Sender: TObject);
var
...
procedure Tformcontaestoque.BtnconsultaabertoClick(Sender: TObject);
begin
  ...
  Formposicaoest.CarregarPosicaodecodinternocadastro; // <-- Esta linha está correta
...
procedure Tformcontaestoque.btnconsultamovClick(Sender: TObject);
begin
...
procedure Tformcontaestoque.btnconsultaprodutosClick(Sender: TObject);
begin
...
procedure Tformcontaestoque.btnconsultarClick(Sender: TObject);
begin
RelatorioManual;
...
Procedure Tformcontaestoque.btnRelatPositivoClick(Sender: TObject);
const
...
procedure Tformcontaestoque.btnrelatnegativoClick(Sender: TObject);
const
...
procedure Tformcontaestoque.btnRetomarProgressoClick(Sender: TObject);
var
...
procedure Tformcontaestoque.btnsalvaprogClick(Sender: TObject);
var
  Msg: String;
  ContadorAjustes: Integer;
  CodProdutoAtual, ProdutoDescricaoAtual, GrupoFiltro,
...
procedure Tformcontaestoque.CarregarGrupos;
begin
...
procedure Tformcontaestoque.CarregarMarcas;
var
  Marca: string;
begin
...
procedure Tformcontaestoque.EditcontagemChange(Sender: TObject);
var
...
procedure Tformcontaestoque.EditcontagemKeyPress(Sender: TObject; var Key: Char);
var
...
procedure Tformcontaestoque.CarregarFornecedores;
begin
...
procedure Tformcontaestoque.FormClose(Sender: TObject;
...
begin
  ...
  inherited; // Chama o destrutor do pai para garantir a limpeza padrão do VCL
end;



procedure Tformcontaestoque.FormShow(Sender: TObject);
begin
...
procedure Tformcontaestoque.QRYHISTORICOAfterScroll(DataSet: TDataSet);
var
...
procedure Tformcontaestoque.QRYRKVENDAfterScroll(DataSet: TDataSet);
var
  CodInterno: string;
begin
...
procedure Tformcontaestoque.RelatorioManual;
var
  SQLText: TStringList;
begin
...
procedure Tformcontaestoque.CriarEstruturaManualCDS;
var
  IndexDef: TIndexDef;
begin
...
procedure Tformcontaestoque.DBGRIDHISTORICODrawColumnCell(Sender: TObject;
...
procedure Tformcontaestoque.DBTextprodutoClick(Sender: TObject);
begin
LocalizarProximoNaoConferido;
end;
...
procedure Tformcontaestoque.TeclaClick(Sender: TObject);
var
  Botao: TBitBtn;
  Caractere: Char;
  Captura: String;
...
procedure Tformcontaestoque.CarregarHistorico;
begin
  try
...
procedure Tformcontaestoque.CarregarItensProgresso(NumRelatorio: Integer);
var
...
procedure Tformcontaestoque.AplicarPeriodoEExecutarRelatorio(NumRelatorio: Integer);
var
...
procedure Tformcontaestoque.AtualizarContadores;
var
...
procedure Tformcontaestoque.Label1Click(Sender: TObject);
begin
LocalizarProximoNaoConferido;
end;
...
procedure Tformcontaestoque.LocalizarProximoNaoConferido;
var
  CodInternoAtual: String;
  Achou: Boolean;
begin
...
procedure Tformcontaestoque.movimentojacontado;
var
  sCodInterno: string;
begin
...
procedure Tformcontaestoque.Estoque_AjustarSaldo(sCodInterno: string; fNovaQuantidade: Extended; iLkUsuario: Integer);
...
procedure Tformcontaestoque.Estoque_RegistrarMovimento(sCodInterno: string; fDiferenca: Extended; fEstoqueAnterior: Extended; fNovaQuantidade: Extended; iLkUsuario: Integer; iLkItem: Integer);
...
procedure Tformcontaestoque.AjustarEstoqueEAtualizarMovimento(Sender: TObject);
var
...
procedure Tformcontaestoque.CalcularETotalizar;
var
  TotalCusto: Currency;
...
begin
  ...
  // 2. Chama a procedure para carregar a posição, passando as datas como parâmetro
  Formposicaoest.CarregarPosicaocodinternovendas; // <-- Esta linha está correta
